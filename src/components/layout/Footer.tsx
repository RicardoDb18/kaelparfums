      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.tiktok.com/@kael.parfums" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-gold transition-colors">
              ...
              <a href="#" className="text-white/40 hover:text-gold transition-colors" title="Instagram">
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-5 text-gold">Comunidad</h3>
            <p className="text-white/50 text-sm mb-4">
              Únete a nuestra comunidad por WhatsApp y recibe novedades, lanzamientos y ofertas exclusivas.
            </p>
            <button
              onClick={handleNewsletter}
              className="w-full px-6 py-3 bg-gold text-black font-semibold text-sm rounded-lg hover:bg-gold-light transition-colors"
            >
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <Link to="/about" className="text-white/30 hover:text-white/60 transition-colors">Términos y Condiciones</Link>
