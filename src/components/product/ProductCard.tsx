...
const brandColors: Record<string, string> = {
  ...
  Mancera: 'bg-zinc-800',
  Montale: 'bg-zinc-800',
  Valentino: 'bg-zinc-800',
  Kenzo: 'bg-zinc-800',
  Azzaro: 'bg-zinc-800',
  'Giorgio Armani': 'bg-zinc-800',
  'Dolce & Gabbana': 'bg-zinc-800',
  Versace: 'bg-zinc-800',
  Lattafa: 'bg-zinc-800',
  Armaf: 'bg-zinc-800',
  Afnan: 'bg-zinc-800',
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-1 mb-3">
          {[...Array(5)].map((_, i) => {
            ...
            return (
              <svg key={i} xmlns="http://www.w3.org/2000/svg" className={`h-3.5 w-3.5 ${filled || half ? 'text-gold' : 'text-zinc-200'}`} viewBox="0 0 20 20" fill="currentColor">
                {half ? (
                  <>
                    <defs>
